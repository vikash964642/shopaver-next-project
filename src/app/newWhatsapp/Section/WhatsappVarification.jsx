...
function WhatsappVarification() {
  return (
    <section className='max-w-[1440px] mx-auto px-[27px] md:px-[47px] xl2:px-[110px] xl3:px-[70px] mt-[90px] lg:mt-[130px] xl3:mt-[150px]'>
        ...
        <div className='flex flex-col items-center gap-[19px] md:gap-[8px] xl2:gap-[15px] '>
  ...
  <div className="flex flex-col md:flex-row xm1:items-center justify-center gap-[19px] md:gap-[50px] w-full">
    ...
    <div className="w-[90%] xm1:w-[333px] md:w-[284px] lg:w-[371px] xl2:w-[478.5px] xl3:w-[596px]">
      <div className="md:w-[66px] md:h-[29px] lg:w-[83px] lg:h-[38px] xl2:w-[97px] xl2:h-[44px]xl2:w-[97px] xl2:h-[44px] border border-[#D9D9FF] md:rounded-[9px] xl2:rounded-[11px] bg-[#F8F8FF] hidden md:flex justify-center items-center">
        <p className="text-[#5801B7] md:text-[12px] lg:text-[14px] xl2:text-[16px] font-medium">Step 01</p>
      </div>

      <h2 className="md:pt-[15px] text-[#5801B7] text-[23.7px] md:text-[21px] lg:text-[27.5px] xl2:text-[35.4px] xl3:text-[44px] font-medium font-bricolage">
        Business Review
      </h2>

      <p className="lg:w-[85%] pt-[4px] xl2:pt-[10px] text-[#666] text-[13.5px] lg:text-[15.5px] xl2:text-[20px] xl3:text-[24px] leading-none">
        Our experts review your business eligibility and brand presence.
      </p>
    </div>
  </div>
  ...
  <div className="flex flex-col-reverse md:flex-row xm1:items-center justify-center gap-[19px] md:gap-[50px] w-full">
    ...
    <div className="  xm1:w-[333px] md:w-[284px] lg:w-[371px] xl2:w-[478.5px] xl3:w-[596px]">
      ...
      <p className="lg:w-[85%] pt-[4px] xl2:pt-[10px] text-[#666] text-[13.5px] lg:text-[15.5px] xl2:text-[20px] xl3:text-[24px]">
        We prepare and verify all necessary business documents.
      </p>
    </div>
  ...
  <div className="md:w-[66px] md:h-[29px] lg:w-[83px] lg:h-[38px] xl2:w-[97px] xl2:h-[44px]xl2:w-[97px] xl2:h-[44px] border border-[#D9D9FF] md:rounded-[9px] xl2:rounded-[11px] bg-[#F8F8FF] hidden md:flex justify-center items-center">
      ...
      <p className="lg:w-[85%] pt-[4px] xl2:pt-[10px] text-[#666] text-[13.5px] lg:text-[15.5px] xl2:text-[20px] xl3:text-[24px]">
        We submit your Blue Tick verification request through the official process.
      </p>
    </div>
  </div>
  ...
  <div className="flex flex-col-reverse md:flex-row items-center justify-center gap-[19px] md:gap-[50px] w-full">
    ...
    <div className=" w-[90%] xm1:w-[333px] md:w-[284px] lg:w-[371px] xl2:w-[478.5px] xl3:w-[596px]">
      ...
      <p className=" lg:w-[85%] pt-[4px] xl2:pt-[10px] text-[#666] text-[13.5px] lg:text-[15.5px] xl2:text-[20px] xl3:text-[24px]">
        WhatsApp reviews your application and approves eligible businesses.
      </p>
    </div>
...
export default WhatsappVarification