...
function LandingPageList() {
  ...
  return (
    <section className="bg-[#E3E3FF] mt-[100px] py-[41px] lg:py-[62px]">
      <div className="max-w-[1850px] px-[22px] xl:px-0 mx-32">
        {/* TITLE */}
      ...
      <div className="grid grid-cols-1 gap-[20px]">
        {listData.slice(groupIndex * 2, groupIndex * 2 + 2).map((item, index) => (
          ...
          <div className="flex justify-center gap-[12.75px] mt-[10px] lg:mt-[40px]">
            <div
              className="custom-prev h-[28px] w-[28px] lg:h-[36.36px] lg:w-[36.36px] rounded-full border-2 border-[#C4C4C4] text-[#C4C4C4]  text-[0.938rem] lg:text-[1.125rem]  flex justify-center items-center cursor-pointer hover:border-[#5801B7] hover:text-[#5801B7] ">
              <i className="fa-solid fa-angle-left"></i>
            </div>
            <div
              className="custom-next w-[28px] h-[28px] lg:h-[36.36px] lg:w-[36.36px] rounded-full border-2 border-[#C4C4C4] text-[#C4C4C4]  text-[0.938rem] lg:text-[1.125rem] flex justify-center items-center cursor-pointer hover:border-[#5801B7] hover:text-[#5801B7]">
  ...
  return (
    <div className="flex items-stretch gap-[14.5px] lg:gap-[35px] bg-white rounded-[25.47px] border border-[#EBD9FF] py-[13px] pl-[20.5px] pr-[12.7px] h-full">
      ...
      <div className="flex flex-col w-[50%] justify-center">
         ...
         <p className="pt-[5.5px] text-[#666] text-[1rem] font-normal leading-normal font-dm-sans line-clamp-5">{item.description}</p>
