...
function RetailHardware() {
  return (
    <section className="max-w-5xl  mx-auto mt-[78px]">
      ...
      <Image src={"/landingPage/RetailHardwareImg1.png"} width={451.88} quality={100} height={461.58} alt="Compatible with All Retail Hardware" className="mt-13 aspect-101/48 h-auto w-full"></Image>
    </section>
  );
}
