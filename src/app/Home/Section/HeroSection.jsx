...
//             India’s Most Trusted POS Billing Software for{" "}
//             <span className="text-[#5801B7] hidden lg:inline">Retail Store</span>
//           </h2>
//              <h2 className="text-[#5801B7] text-[26px] sm:text-[30px] font-semibold text-center block lg:hidden">Retail Store</h2>
...
//             Power your retail business with an All-In-One POS that goes beyond
//             billing. Manage fast checkouts, real-time inventory, smart
//             analytics, online store, WhatsApp Commerce, and Marketing from one
//             unified dashboard.
//           </p>
...
//           <Image src={"/img/landingHeroImg.webp"} className="h-[287px] w-[248.3px] sm:h-[452px] sm:w-[391px]" height={452} width={391} alt="Hero Section Image"></Image>
//       </div>
