...
function CardSlider() {
 ...
 <div className='lg:max-w-5xl xl:max-w-[76.25rem] xl2:max-w-[90rem] mx-auto md:px-[32px] lg:px-[47px] xl:px-[40px] xl2:px-[35px] py-[4.3rem] md:py-[60px] lg:py-[80px] xl2:py-[97px]'>
     <div className="">
 <div className='flex flex-col gap-[1.25rem] items-center'>
      ...
      <div className="space-y-[5rem] mx-[0.77rem] md:mx-0 mt-[2rem] md:mt-[4rem] lg:mt-[5rem]">
        ...
        <div
          ...
          style={getStyle(0)}
          className="sticky w-full md:h-[377px] lg:h-[40vw] xl:h-[36vw] xl2:h-[700px] px-[1.5625rem] pt-[2.5rem] pb-[4.3rem] md:pt-0 md:pb-0 md:px-[1.5rem] lg:px-[2.09375rem] xl2:px-[2.5rem] rounded-[1.875rem] border shadow-xl bg-[#075E54] will-change-transform flex justify-between items-center gap-[4rem] md:gap-[2.2rem] flex-col md:flex-row overflow-hidden"
        >
          <div className="w-full md:w-[50%] shrink-0">
            <h1 className='text-[#FFF] text-[1.125rem] md:text-[0.91rem] lg:text-[1.21rem] xl:text-[23.4px] xl2:text-[28.3px] font-semibold leading-normal font-bricolage'>AI Flow Builder</h1>
            <h2 className='text-[#FFF] pt-[0.3125rem] md:w-[14.28rem] lg:w-[75%] text-[1.75rem] md:text-[1.67rem] lg:text-[2.22rem] xl:text-[43px] xl2:text-[51.9px] font-medium lg:font-semibold leading-none md:leading-[2rem] lg:leading-[2.663rem] xl2:leading-[3.23rem] font-bricolage'>Design a no-code chats in minutes</h2>
            <p className='pt-[0.625rem] md:w-[15rem] lg:w-[75%] xl2:w-[468px] text-[#FFF] text-[0.875rem] lg:text-[0.97rem] xl:text-[18.75px] xl2:text-[22.6px] font-normal leading-normal font-dm-sans'>Create flows with drag and drop, or simply describe your flow and let AI build it for you.</p>
            <button className='bg-[#FFF] mt-[1.25rem] lg:mt-[1.875rem] xl2:mt-[42px]  rounded-[0.5625rem] lg:rounded-[0.6875rem] h-[2.8125rem] w-[7.75rem] lg:h-[3.27rem] xl2:h-[76px] lg:w-[9.3125rem] xl2:w-[210px]  text-[0.833rem] lg:text-[1rem] xl:text-[18.75px] xl2:text-[22.6px] text-[#525252] font-medium font-dm-sans'>Know More</button>
          </div>
        ...
        >
          ...
          <div className="w-full md:w-[50%] shrink-0">
            ...
            <h2 className='text-[#FFF] pt-[0.3125rem] md:w-[17.75rem] lg:w-full text-[1.75rem] md:text-[1.67rem] lg:text-[2.22rem] xl:text-[43px] xl2:text-[51.9px] font-medium lg:font-semibold leading-none md:leading-[2rem] lg:leading-[2.663rem] xl2:leading-[3.23rem] font-bricolage'>Turn Every Chat Into a Sales on WhatsApp</h2>
            <p className='pt-[0.625rem] lg:w-[22.3rem] xl2:w-[520px] text-[#FFF] text-[0.875rem] lg:text-[0.97rem] xl:text-[18.75px] xl2:text-[22.6px] font-normal leading-normal font-dm-sans'>Automate conversations, track customer behavior & close more deals—without missing a single message.</p>
            <button className='mt-[1.25rem] lg:mt-[1.875rem] xl2:mt-[42px] bg-[#FFF] rounded-[0.5625rem] lg:rounded-[0.6875rem] h-[2.8125rem] w-[7.75rem] lg:h-[3.27rem] xl2:h-[76px] lg:w-[9.3125rem] xl2:w-[210px]  text-[0.833rem] lg:text-[1rem] xl:text-[18.75px] xl2:text-[22.6px] text-[#525252]  font-medium font-dm-sans'>Know More</button>
          </div>
        </div>
        ...
        >
          <div className="w-full md:w-[50%] shrink-0">
            ...
            <h2 className='text-[#075E54] pt-[0.3125rem] md:w-[17.75rem] lg:w-[23.75rem] xl2:w-[514px] text-[1.75rem] md:text-[1.67rem] lg:text-[2.22rem] xl:text-[43px] xl2:text-[51.9px] font-medium lg:font-semibold leading-none md:leading-[2rem] lg:leading-[2.663rem] xl2:leading-[3.23rem] font-bricolage'>Increase Sales with Targeted Campaigns</h2>
            <p className=' text-[#525252] pt-[0.625rem] lg:w-[21.75rem] xl2:w-[506px] text-[0.875rem] lg:text-[0.97rem] xl:text-[18.75px] xl2:text-[22.6px] font-normal leading-normal font-dm-sans'>Send bulk broadcasts, personalized campaigns, and promotional offers in one click.</p>
            <button className='mt-[1.25rem] lg:mt-[1.875rem] xl2:mt-[42px] bg-[#075E54] rounded-[0.5625rem] lg:rounded-[0.6875rem] h-[2.8125rem] w-[7.75rem] lg:h-[3.27rem] xl2:h-[76px] lg:w-[9.3125rem] xl2:w-[210px]  text-[0.833rem] lg:text-[1rem] xl:text-[18.75px] xl2:text-[22.6px] text-[#FFF] font-medium font-dm-sans'>Know More</button>
          </div>
          <div className="w-full md:w-[50%] md:h-full flex justify-center items-center ">
        ...
        >
          ...
          <div className="w-full md:w-[50%] shrink-0">
            ...
            <h2 className=' text-[#075E54] pt-[0.3125rem] md:w-[17.75rem] lg:w-[23.75rem] xl2:w-[515px] text-[1.75rem] md:text-[1.67rem] lg:text-[2.22rem] xl:text-[43px] xl2:text-[51.9px] font-medium lg:font-semibold leading-none md:leading-[2rem] lg:leading-[2.663rem] xl2:leading-[3.23rem] font-bricolage'>Sales and Payments All in One Place</h2>
            <p className='text-[#525252] pt-[0.625rem] md:w-[17.5rem] lg:w-[20.75rem] xl2:w-[481px] text-[0.875rem] lg:text-[0.97rem] xl:text-[18.75px] xl2:text-[22.6px] font-normal leading-normal font-dm-sans'>Collect payments seamlessly inside WhatsApp via UPI, cards, and net banking.</p>
            <button className='mt-[1.25rem] lg:mt-[1.875rem] xl2:mt-[42px] bg-[#075E54] rounded-[0.5625rem] lg:rounded-[0.6875rem] h-[2.8125rem] w-[7.75rem] lg:h-[3.27rem] xl2:h-[76px] lg:w-[9.3125rem] xl2:w-[210px]  text-[0.833rem] lg:text-[1rem] xl:text-[18.75px] xl2:text-[22.6px] text-[#FFF] font-medium font-dm-sans'>Know More</button>
          </div>
        </div>
        ...
        >
          ...
          <div className="w-full md:w-[50%] shrink-0">
            ...
            <h2 className=' text-[#2E9F49] pt-[0.3125rem] md:w-[21rem] lg:w-[28rem] xl2:w-[648px] text-[1.75rem] md:text-[1.67rem] lg:text-[2.22rem] xl:text-[43px] xl2:text-[51.9px] font-medium lg:font-semibold leading-normal md:leading-[2rem] lg:leading-[2.663rem] xl2:leading-[3.23rem] font-bricolage'>Get a QR Code to Connect your customers instantly</h2>
            <p className='text-[#525252] pt-[0.625rem] md:w-[17.5rem] lg:w-[20.75rem] xl2:w-[550px] text-[0.875rem] lg:text-[0.97rem] xl:text-[18.75px] xl2:text-[22.6px] font-normal leading-none font-dm-sans'>Automate conversations, track customer behavior & close more deals—without missing a single message.</p>
            <button className='mt-[1.25rem] lg:mt-[1.875rem] xl2:mt-[42px] bg-[#2E9F49] rounded-[0.5625rem] lg:rounded-[0.6875rem] h-[2.8125rem] w-[7.75rem] lg:h-[3.27rem] xl2:h-[76px] lg:w-[9.3125rem] xl2:w-[210px]  text-[0.833rem] lg:text-[1rem] xl:text-[18.75px] xl2:text-[22.6px] text-[#FFF] font-medium font-dm-sans'>Know More</button>
          </div>
        </div>
