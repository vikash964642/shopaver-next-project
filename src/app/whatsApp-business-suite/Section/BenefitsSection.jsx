...
function BenefitsSection() {
  ...
  return (
    <section className="xl2:max-w-[1220px] xl3:max-w-[90rem] mx-auto  md:px-[65px] lg:px-[93px] xl2:px-[60px]  xl3:px-[72px] w-full  mt-[90px] lg:mt-[110px] xl2:mt-[130px] xl3:mt-[170px]">
        ...
        {/* CARDS */}
        <div className="mt-6 md:mt-7 lg:mt-10 xl2:mt-12 xl3:mt-14 hidden sm:grid sm:grid-cols-2 md:grid-cols-3 gap-3 lg:gap-5 xl2:gap-6 ">
          
          {benefits.map((item, index) => (
            <div
              key={index}
              className="rounded-[22px] lg:rounded-[28px] border border-[#D9D3FF] bg-[#F8F8FF] p-4 lg:p-5 flex flex-col justify-between"
            >
          ...
          <div className="ml-[20.5px] mt-[1.5625rem] lg:mt-[3.4375rem] relative overflow-hidden block sm:hidden">
  <Swiper
