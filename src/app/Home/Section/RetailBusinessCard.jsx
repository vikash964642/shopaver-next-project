...
<div className="grid grid-cols-1 sm:grid-cols-2 gap-[10.5px] lg:gap-[17.57px] mt-10">
      ...
      <Card item={item} />
        ...
        {!showAll && (
          <div className="flex justify-center mt-6 sm:hidden">
            <div  onClick={() => setShowAll(true)} className="flex justify-center items-center gap-[5px] w-[111px] h-11 rounded-xl bg-[#5801B7] border-[0.748px] border-[#F0E2FF]">
                <p className="text-[#FFF] text-[16px] font-medium leading-normal font-[Poppins]">More</p>
                <div className="flex justify-center items-center h-[15px] w-[15px] rounded-full bg-[#FFF]">
                    <Image src="/landingPage/ArrowDown.svg" alt="Arrow" width={8} height={10}></Image>
                </div>
            </div>
          </div>
        )}
...
function Card({ item }) {
 ...
 <div className="flex flex-col flex-1 justify-end h-full">
    ...
    <Image src="/landingPage/Arrow.svg" alt="Arrow" width={10} height={5}></Image>
      ...
      <Image src={item.image} alt="Image" className="shrink-0 w-[147px] h-[153px] lg:w-[218px] lg:h-[227px]"  width={218} height={227}
      />
    </div>
  );
}
